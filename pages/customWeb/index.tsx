  ...
  return (
    <div className="min-h-screen mt-8">
      ...
      <div className="container p-8 mx-auto">
        <h1 className="mb-6 text-4xl font-bold text-center">Custom Website Development</h1>

        <h1 className="mt-2 mb-6 text-3xl font-bold text-left">Cool UI/UX Application</h1>
